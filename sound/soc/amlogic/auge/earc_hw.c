				  ...
				  enum audio_coding_types coding_type)
{
	...
	case AUDIO_CODING_TYPE_ENCODED_LAYOUT_B:
		 ...
		 * of padding inherent to Layout B in hardware so all of the
		 * data must be conveyed to user-space.
		 */
		channels = 8;
		break;
	default:
