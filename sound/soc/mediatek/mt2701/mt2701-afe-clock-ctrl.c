...
void mt2701_tdm_clk_configuration(struct mtk_base_afe *afe, int tdm_id,
						struct snd_pcm_hw_params *params)
{
	...
	if (tdm_id == MT2701_TDMO_1)
		regmap_update_bits(afe->regmap, FPGA_CFG2, 1 << 0, 1 << 0);
	else if (tdm_id == MT2701_TDMO_2)
		regmap_update_bits(afe->regmap, FPGA_CFG2, 1 << 1, 1 << 1);
	else if (tdm_id == MT2701_TDMI)
	...
	if (apll_sel == 1) {
		if (mclk > AUDIO_CLOCK_49M)
			mclk_div = 1;
		else
			mclk_div = AUDIO_CLOCK_49M / mclk;

		regmap_update_bits(afe->regmap, FPGA_CFG3, 0xffff, (mclk_div - 1) << 8 | (mclk_div - 1) << 0);
	} else {
		if (mclk > AUDIO_CLOCK_45M)
			mclk_div = 1;
		else
			mclk_div = AUDIO_CLOCK_45M / mclk;
	...
	/* Audio Top Config */
	if (!(AUDIO_CLOCK_49M % bck)) {
		if (bck > AUDIO_CLOCK_49M)
			apll_div = 1;
		else
			apll_div = AUDIO_CLOCK_49M / bck;

		if (tdm_id == MT2701_TDMO_1) {
			regmap_update_bits(afe->regmap, AUDIO_TOP_CON2, AUDIO_TOP_CON2_TDMOUT1_PLL_SEL,
					   AUDIO_TOP_CON2_TDMOUT1_PLL_SEL_APLL1);
			regmap_update_bits(afe->regmap, AUDIO_TOP_CON2, AUDIO_TOP_CON2_TDMOUT1_BCK_PLL_DIV,
					   AUDIO_TOP_CON2_TDMOUT1_BCK_PLL_DIV_SET(apll_div - 1));
			regmap_update_bits(afe->regmap, AUDIO_TOP_CON2, AUDIO_TOP_CON2_TDMOUT1_BCK_EN,
					   AUDIO_TOP_CON2_TDMOUT1_BCK_EN);
		} else if (tdm_id == MT2701_TDMO_2) {
			regmap_update_bits(afe->regmap, AUDIO_TOP_CON2, AUDIO_TOP_CON2_TDMOUT2_PLL_SEL,
					   AUDIO_TOP_CON2_TDMOUT2_PLL_SEL_APLL1);
			regmap_update_bits(afe->regmap, AUDIO_TOP_CON2, AUDIO_TOP_CON2_TDMOUT2_BCK_PLL_DIV,
					   AUDIO_TOP_CON2_TDMOUT2_BCK_PLL_DIV_SET(apll_div - 1));
			regmap_update_bits(afe->regmap, AUDIO_TOP_CON2, AUDIO_TOP_CON2_TDMOUT2_BCK_EN,
					   AUDIO_TOP_CON2_TDMOUT2_BCK_EN);
		} else {
			regmap_update_bits(afe->regmap, AUDIO_TOP_CON1, AUDIO_TOP_CON1_TDMIN_PLL_SEL,
					   AUDIO_TOP_CON1_TDMIN_PLL_SEL_APLL1);
			regmap_update_bits(afe->regmap, AUDIO_TOP_CON1, AUDIO_TOP_CON1_TDMIN_BCK_PLL_DIV,
					   AUDIO_TOP_CON1_TDMIN_BCK_PLL_DIV_SET(apll_div - 1));
			regmap_update_bits(afe->regmap, AUDIO_TOP_CON1, AUDIO_TOP_CON1_TDMIN_BCK_EN,
					   AUDIO_TOP_CON1_TDMIN_BCK_EN);
		}
	} else {
		if (bck > AUDIO_CLOCK_45M)
			apll_div = 1;
		else
			apll_div = AUDIO_CLOCK_45M / bck;

		if (tdm_id == MT2701_TDMO_1) {
			regmap_update_bits(afe->regmap, AUDIO_TOP_CON2, AUDIO_TOP_CON2_TDMOUT1_PLL_SEL,
					   AUDIO_TOP_CON2_TDMOUT1_PLL_SEL_APLL2);
			regmap_update_bits(afe->regmap, AUDIO_TOP_CON2, AUDIO_TOP_CON2_TDMOUT1_BCK_PLL_DIV,
					   AUDIO_TOP_CON2_TDMOUT1_BCK_PLL_DIV_SET(apll_div - 1));
			regmap_update_bits(afe->regmap, AUDIO_TOP_CON2, AUDIO_TOP_CON2_TDMOUT1_BCK_EN,
					   AUDIO_TOP_CON2_TDMOUT1_BCK_EN);
			...
			regmap_update_bits(afe->regmap, AUDIO_TOP_CON1, AUDIO_TOP_CON1_TDMIN_PLL_SEL,
					   AUDIO_TOP_CON1_TDMIN_PLL_SEL_APLL2);
			regmap_update_bits(afe->regmap, AUDIO_TOP_CON1, AUDIO_TOP_CON1_TDMIN_BCK_PLL_DIV,
					   AUDIO_TOP_CON1_TDMIN_BCK_PLL_DIV_SET(apll_div - 1));
			regmap_update_bits(afe->regmap, AUDIO_TOP_CON1, AUDIO_TOP_CON1_TDMIN_BCK_EN,
					   AUDIO_TOP_CON1_TDMIN_BCK_EN);
