...
#define	RG_OPMODE_SHIFT			(0)
#define	RG_TERMSEL_SHIFT		(2)
#define	RG_XCVRSEL_SHIFT		(4)
#define	RG_DPPULLDOWN_SHIFT		(6)
#define	RG_DMPULLDOWN_SHIFT		(7)
#define	RG_TXVALID_SHIFT		(8)
#define	RG_TXVALID_H_SHIFT		(9)
#define	RG_VBUSVALID_SHIFT		(5)
#define RG_SUSPENDM_SHIFT		(3)
