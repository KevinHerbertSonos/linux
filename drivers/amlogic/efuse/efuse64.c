...
static const struct SonosFuseEntry fuseMapping[] =
{
	...
	{
		(uint32_t)EFUSE_OBJ_LICENSE_ENABLE_M3_SECURE_BOOT,
		"ENABLE_M3_SECURE_BOOT", 1
	},
	{
		(uint32_t)EFUSE_OBJ_LICENSE_ENABLE_M3_ENCRYPTION,
		"ENABLE_M3_ENCRYPTION", 1
	},
	{
		(uint32_t)EFUSE_OBJ_LICENSE_ENABLE_M4_SECURE_BOOT,
		"ENABLE_M4_SECURE_BOOT", 1
	},
	{
		(uint32_t)EFUSE_OBJ_LICENSE_ENABLE_M4_ENCRYPTION,
		"ENABLE_M4_ENCRYPTION", 1
	},
	{
		(uint32_t)EFUSE_OBJ_LICENSE_REVOKE_M4_KPUB_0,
		"REVOKE_M4_KPUB_0", 1
	},
	{
		(uint32_t)EFUSE_OBJ_LICENSE_REVOKE_M4_KPUB_1,
		"REVOKE_M4_KPUB_1", 1
	},
	{
		(uint32_t)EFUSE_OBJ_LICENSE_ENABLE_M4_JTAG_PASSWORD,
		"ENABLE_M4_JTAG_PASSWORD", 1
	},
	{
		(uint32_t)EFUSE_OBJ_LICENSE_DISABLE_M3_JTAG,
		"DISABLE_M3_JTAG", 1
	},
	{
		(uint32_t)EFUSE_OBJ_LICENSE_DISABLE_M4_JTAG,
		"DISABLE_M4_JTAG", 1
	},
#endif
	{
	...
	{
		(uint32_t)EFUSE_OBJ_AUDIO_CUSTOMER_ID,
		"AUDIO_CUSTOMER_ID", 4
	},
#if defined(SONOS_ARCH_ATTR_SOC_IS_S767)
	{
		(uint32_t)EFUSE_OBJ_M4_SBOOT_AES256_SHA2,
...
#if defined(SONOS_ARCH_ATTR_SOC_IS_S767)
	__ATTR(ENABLE_M3_SECURE_BOOT, S_IRUGO, efuse_obj_show, NULL),
	__ATTR(ENABLE_M3_ENCRYPTION, S_IRUGO, efuse_obj_show, NULL),
	__ATTR(ENABLE_M4_SECURE_BOOT, S_IRUGO, efuse_obj_show, NULL),
	__ATTR(ENABLE_M4_ENCRYPTION, S_IRUGO, efuse_obj_show, NULL),
	__ATTR(REVOKE_M4_KPUB_0, S_IRUGO, efuse_obj_show, NULL),
	__ATTR(REVOKE_M4_KPUB_1, S_IRUGO, efuse_obj_show, NULL),
	__ATTR(ENABLE_M4_JTAG_PASSWORD, S_IRUGO, efuse_obj_show, NULL),
	__ATTR(DISABLE_M3_JTAG, S_IRUGO, efuse_obj_show, NULL),
	__ATTR(DISABLE_M4_JTAG, S_IRUGO, efuse_obj_show, NULL),
	__ATTR(M4_SBOOT_AES256_SHA2, S_IRUGO, efuse_obj_show, NULL),
#endif
	__ATTR_NULL
